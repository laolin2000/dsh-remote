...
> 测试合计 **422 项断言**：守卫 141 / 二维码 46 / 面板（真实 DOM）73 / 插件路由 55 / 桌面工具 15 / 安装器 28 / 一键安装 31 / 文档审计 22 / 隧道实测 11，
> 全绿。逐条验证记录见文末「验证记录」。
...
test/                测试：selftest(141) qr(46) panel.dom(73) plugin(55) bin(15) install(28) setup(31) docaudit(22) tunnel(11)
...
- **守卫**：`test/selftest.mjs`（141 项）—— fail-closed、配对码、长期链接语义、**链接 token 优先于已有会话**、
