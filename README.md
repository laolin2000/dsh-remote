...
> 测试合计 **355 项断言**：守卫 125 / 二维码 46 / 面板（真实 DOM）68 / 插件路由 51 / 桌面工具 15 / 安装器 28 / 一键安装 30 / 隧道实测 11，
> 全绿。逐条验证记录见文末「验证记录」。
...
test/                测试：selftest(125) qr(46) panel.dom(68) plugin(51) bin(15) install(28) setup(30) tunnel(11)
