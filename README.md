...
> 测试合计 **339 项断言**：守卫 117 / 二维码 46 / 面板（真实 DOM）58 / 插件路由 44 / 桌面工具 15 / 安装器 28 / 一键安装 30 / 隧道实测 11，
> 全绿。逐条验证记录见文末「验证记录」。
...
test/                测试：selftest(117) qr(46) panel.dom(58) plugin(44) bin(15) install(28) setup(30) tunnel(11)
