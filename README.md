...
> 测试合计 **324 项断言**：守卫 117 / 二维码 46 / 面板（真实 DOM）51 / 插件路由 29 / 桌面工具 15 / 安装器 28 / 一键安装 27 / 隧道实测 11，
> 全绿。逐条验证记录见文末「验证记录」。
...
test/                测试：selftest(117) qr(46) panel.dom(51) plugin(29) bin(15) install(28) setup(27) tunnel(11)
